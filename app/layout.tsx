...
export const metadata = {
  title: "BoardSort.nl — Verkoop je pc-onderdelen snel & eerlijk",
  description: "BoardSort.nl koopt gebruikte pc-componenten op: moederborden, GPU's, CPU's en meer. Gratis verzenden, eerlijke marktprijs en uitbetaling binnen 24 uur. Voor particulieren en bedrijven in heel Nederland.",
};
